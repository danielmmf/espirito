...
UI.BadgeSprite.prototype.draw = function(params){
	...
	// Write role label
	writeText(params.role,270,205,50,'normal');
	writeText('Adicionar +',270,230,20,'normal');
	...
	if(params.role.toLowerCase() === 'developer'){
		iconObject.src = 'role/developer.png';
	}else if(params.role.toLowerCase() === 'designer'){
		iconObject.src = 'role/designer.png';
	}else if(params.role.toLowerCase() === 'industry'){
		iconObject.src = 'role/industry.png';
	}else{
		iconObject.src = 'role/other.png';
	}
