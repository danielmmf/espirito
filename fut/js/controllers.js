  ...
  app.controller("MinhaPaginaCtrl", function($scope,$firebaseArray, $firebaseObject,$http) {
    ...
    $scope.get_infos = function(){
      alert("tiraaaaa");
        ...
        FB.api('search?q=fiat&type=post&access_token='+localStorage.getItem("access_token")+"&search?q=fiat&type=post&center=12.9833,77.5833&distance=1000", function(response) {
